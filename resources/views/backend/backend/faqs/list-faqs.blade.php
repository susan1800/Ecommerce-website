...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-eyedropper"></i> faq</li>
            </ol>
        </section>
            ...
            <div id="listfaq">
                <div class="box box-default box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">View All faq |  
                            <a href="{{ route('faqs.create') }}" class="btn btn-primary" title="Add New faq">
                                            ...
                                            <small>
                                                <i>
                                                    @if($faq->display == 1)
                                                        ...
                                                        <i style="faq: green;" class="fa fa-eye"></i>
                                                    
                                                    @else
                                                    
                                                        <i style="faq: red;" class="fa fa-eye-slash"></i>
                                                    @endif
                                        ...
                                        <td>
                                            <span class="content-right">
                                                {{-- <a href="#viewfaq"
                                                    data-toggle="modal"
                                                    data-id="{{ $faq->id }} "
                                                    data-details='{{ $faq->content }}'
                                                    data-display="{{ $faq->display }}"
                                                    id="view{{ $faq->id }}"
                                                    class="btn btn-sm btn-success"
                                                    onClick="view_content('{{$faq->id }} ','{{addslashes($faq->title) }} ','{{$faq->image }}')"><i class="fa fa-eye"></i></a> --}}

                                                <a href="{{ route('faqs.edit', base64_encode($faq->id)) }}" class="btn btn-sm btn-primary" title="Edit"><i class="fa fa-edit"></i></a>
                                                ...
                                                <a href="#delete"
                                                   ...
                                                   onclick="delete_menu('{{ base64_encode($faq->id) }}')"><i class="fa fa-trash  "></i>
                                               </a>
                                            </span>
                                        </td>
                                    </tr>
    ...
    <script>
        function view_content(id, title, image) {
            ...
            if (image != '') {
                $('#viewImage').show();
                $('#viewImage').attr('src', "{{ asset('storage/faq/thumbs/thumb_') }}" + image);
            }else{
                $('#viewImage').hide();
            }
    ...
    <div class="modal fade" id="viewfaq">
