                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-group mb-2 mr-sm-2">
                                        ...
                                        <input type="text" class="form-control" name="name" placeholder="Role Name" required value="{{ $role->name}}">
                                    </div>
                                </div>
                            </div>
                            <div class=" row">
                                            ...
                                            @foreach($permissions as $key => $value)
                                                ...
                                                <div class="col-md-3 mb-2">
                                                    <div class="input-group">
                                                        <div class="input-group-addon">
                                                            <input class="form-check-input permission" {{ in_array($value->id, $rolePermissions) ? 'checked' : '' }} type="checkbox" name="permission[]" value="{{ $value->id }}">
                                                        </div>
