...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-eyedropper"></i> testimonial</li>
            </ol>
        </section>
        ...
        <section class="content">
            ...
            <!-- Default box -->
            <div id="listtestimonial">
                <div class="box box-default box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">View All testimonial |  
                            <a href="{{ route('testimonials.create') }}" class="btn btn-primary" title="Add New testimonial">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <img width="20%" class="img-thumbnail" src="{{ asset('storage/testimonial/'.$testimonial->image) }}">
                                            <small>
                                                <i>
                                                    @if($testimonial->display == 1)
                                                    
                                                        <i style="testimonial: green;" class="fa fa-eye"></i>
                                                    
                                                    @else
                                                    
                                                        <i style="testimonial: red;" class="fa fa-eye-slash"></i>
                                                    @endif
                                        ...
                                        <td>
                                            <span class="content-right">
                                                {{-- <a href="#viewtestimonial"
                                                    ...
                                                    data-details='{{ $testimonial->content }}'
                                                    data-display="{{ $testimonial->display }}"
                                                    id="view{{ $testimonial->id }}"
                                                    class="btn btn-sm btn-success"
                                                    onClick="view_content('{{$testimonial->id }} ','{{addslashes($testimonial->title) }} ','{{$testimonial->image }}')"><i class="fa fa-eye"></i></a> --}}

                                                <a href="{{ route('testimonials.edit', base64_encode($testimonial->id)) }}" class="btn btn-sm btn-primary" title="Edit"><i class="fa fa-edit"></i></a>
                                                
                                                
                                                <a href="#delete"
                                                   data-toggle="modal"
                                                   data-id="{{ $testimonial->id }}"
                                                   id="delete{{ $testimonial->id }}"
                                                   title="Delete" 
                                                   class="btn btn-sm btn-danger"
                                                   onclick="delete_menu('{{ base64_encode($testimonial->id) }}')"><i class="fa fa-trash  "></i>
                                               </a>
                                            </span>
                                        </td>
                                    </tr>
    ...
    <script>
        function view_content(id, title, image) {
            ...
            if (image != '') {
                $('#viewImage').show();
                $('#viewImage').attr('src', "{{ asset('storage/testimonial/thumbs/thumb_') }}" + image);
            }else{
                $('#viewImage').hide();
            }
        ...
        function delete_menu(id) {
            var conn = './testimonial/delete/' + id;
    ...
    <div class="modal fade" id="viewtestimonial">
