	                	    ...
	                	    <div class="col-md-6">
	                	        <div class="box box-default box-solid">
									...
									<div style="padding:10px">
										...
										<p>Payment Status : @if($order->payment_status == 1) Paid @else Unpaid @endif</p>
                                        <p style="height:250px;">

                                            @if($order->payment_type == "QR Scan")
                                            Image:&nbsp;&nbsp;&nbsp;
                                            <a href="{{asset('storage/'.$order->payment_image)}}" target="blank">
                                            <img src="{{asset('storage/'.$order->payment_image)}}" style="width:200px; height:200px; ">
                                            </a>
                                            @endif
                                        </p>
									</div>
	                	    ...
	                	    <div class="col-md-6">
	                	        <div class="box box-default box-solid">
									...
									<div style="padding:10px">
										...
										<p style="height:220px;">Delivery Address : {{$order->shipping_address}}</p>
